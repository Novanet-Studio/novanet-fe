<template>
  <section class="section section--home">
    ...
    <div class="shapes" v-if="services?.data?.servicio?.servicios?.length">
      <button class="shapes__item" v-for="service in services?.data?.servicio?.servicios" :id="service.id" @click="
  () => {
    showModal = true;
...
">
        <nuxt-img class="shapes__img" :src="service.imagen.url" :alt="service.imagen.alternativeText" width="290"
          background="#d6f630" quality="1" loading="lazy" />
