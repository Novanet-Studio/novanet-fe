    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-[2fr_3fr] lg:gap-12">
      <div class="flex flex-col gap-4 lg:gap-4">
        ...
        <h1 v-if="content.sectionTitle" :class="[`main__title`, content.titleColor]">
          <Motion :key="content.sectionTitle" :initial="animations.mainTitle.initial"
        ...
        <p v-if="currentItem.date" :class="content.dateColor || 'text-gray-500'">
          <Motion :key="currentItem.title" :initial="animations.description.initial"
        ...
        <Motion :key="currentItem.title" :initial="animations.cta.initial" :animate="animations.cta.animate"
      ...
      <Motion :key="currentItem.title" :initial="animations.mainImage.initial" :animate="animations.mainImage.animate"
          ...
          <div class="overflow-hidden max-h-[50vh]">
            <div ref="carouselTrackEl"
              ...
              <div v-for="item in content.items" :key="item.cta_route" :class="[
                ...
                <NuxtImg v-else @click="gotoItem(item)" :src="item.portrait" :alt="item.title"
