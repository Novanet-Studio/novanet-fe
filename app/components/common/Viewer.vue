    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-[2fr_3fr] lg:gap-12">
      <div class="flex flex-col gap-4 lg:gap-4">
        <h1 v-if="content.sectionTitle" :class="[`main__title`, content.titleColor]">
          <Motion :initial="animations.mainTitle.initial" :animate="hasBeenAnimated(props.content.sectionName)
        ...
        <p v-if="currentItem.date" :class="content.dateColor || 'text-gray-500'">
          <Motion :initial="animations.description.initial" :animate="hasBeenAnimated(props.content.sectionName)
        ...
        <Motion :initial="animations.cta.initial" :animate="hasBeenAnimated(props.content.sectionName)
      ...
      <Motion :initial="animations.mainImage.initial" :animate="hasBeenAnimated(props.content.sectionName)
            ...
            <div ref="carouselTrackEl"
              ...
              <div v-for="item in content.items" :key="item.cta_route" :class="[
                ...
                <NuxtLink v-if="item === currentItem" :to="item.cta_route">
                  <NuxtImg provider="cloudinary" :src="item.portrait" :alt="item.title"
                    class="md:max-h-[30vh] lg:max-h-[50vh] w-full h-auto object-cover" />
                </NuxtLink>

                <NuxtImg v-else provider="cloudinary" @click="gotoItem(item)" :src="item.portrait" :alt="item.title"
