...
<template>
  ...
  >
    ...
    >
      ...
      >
        <Motion
          :key="data.backLink.text"
          :initial="animations.FifthElement.initial"
          :animate="animations.FifthElement.animate"
          :transition="{ ...animations.FifthElement.transition }"
        >
          <NuxtLink
        ...
        <Motion
          :key="data.date"
          :initial="animations.FourthElement.initial"
          :animate="animations.FourthElement.animate"
