...
<template>
  <header
    class="fixed top-0 w-full bg-transparent px-6 pt-8 md:px-9 lg:px-12 lg:pt-12 transition-colors z-50"
  ...
  >
    ...
    >
      ...
      <aside
        class="flex flex-col pt-8 pl-6 pr-4 transform top-0 right-0 w-2/5 bg-eerieBlack absolute h-[100dvh] overflow-auto ease-in-out transition-all duration-300 z-[60]"
      ...
      >
        ...
        <div class="flex gap-1 h-9 w-full justify-start mt-4 text-columbiaBlue">
          <a
      ...
      >
        <div
          ...
          v-show="isOpen"
          class="z-[55] fixed inset-0 transition-opacity"
        >
          <div
            @click="isOpen = false"
